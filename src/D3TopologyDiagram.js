...
function D3TopologyDiagram({ allAssets, backButtonHandler }) {
  ...
  const colors = {
    rootNodeBackground: "#8BAE66",
    rootNodeBorder: "#628141",
    level1NodeBackground: "#AAC4F5",
    level1NodeBorder: "#8CA9FF",
    nodeBgNormal: "#e3f2fd",
  ...
  const draw = () => {
    ...
    nodeGroups.each(function (d) {
      ...
      if (selectedNodeIds.includes(d.id)) {
        ...
        nodeStyle = {
          fill: colors.rootNodeBackground,
        ...
        nodeStyle = {
          fill: colors.level1NodeBackground,
          stroke: colors.level1NodeBorder,
          strokeWidth: "2px",
        };
        labelColor = "#000";
      } else {
    ...
    nodeGroups
      ...
      .on("mouseout", function (event, d) {
        ...
        if (selectedNodeIds.includes(d.id)) {
          ...
          strokeColor = colors.rootNodeBorder;
          strokeWidth = "3px";
        } else if (level === 1) {
          strokeColor = colors.level1NodeBorder;
          strokeWidth = "2px";
        } else {
    ...
    // Zoom-to-fit function — only called by button
    const zoomToFit = () => {
